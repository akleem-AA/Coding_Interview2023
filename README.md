...
> [!NOTE]  
> This is a practice set only based on the JavaScript syntax and behaviour at that time. Since JavaScript is a constantly evolving language, there are newer language features that are not covered by the questions here.
...
<p align="center">Feel free learn from here 😊</p>
